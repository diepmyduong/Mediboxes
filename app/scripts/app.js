...
var config = {
  apiKey: "AIzaSyASHvFzxRX1m7GOkaBnCEy1WtjWJSwyeZw",
  authDomain: "esdc-97e28.firebaseapp.com",
  databaseURL: "https://esdc-97e28.firebaseio.com",
  storageBucket: "esdc-97e28.appspot.com",
};
...
var app = angular
  ...
  .run(['$rootScope', '$state', '$stateParams', function($rootScope, $state, $stateParams) {
    ...
    //       // do something
    //   if(toState.name == "dicomviewer" && toParams.patient == 'clearurl'){
  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    //folder page
    .state('app.pages.folder', {
      url: '/patients',
      controller: 'FolderPageCtrl',
      templateUrl: 'views/tmpl/pages/folder.html'
    })
    //patient page
    .state('app.pages.patient', {
      url: '/patients/:SOPClassUID',
      controller: 'PatientPageCtrl',
      templateUrl: 'views/tmpl/pages/patient.html'
    })
    //mail
    .state('app.pages.mail', {
      abstract: true,
      url: '/mail',
      controller: 'PageMailCtrl',
      templateUrl: 'views/tmpl/pages/mail.html'
    })
    //mail/inbox
    .state('app.pages.mail.inbox', {
      url: '/inbox',
      controller: 'PageInboxCtrl',
      templateUrl: 'views/tmpl/pages/inbox.html'
    })
    //documentation
    .state('app.help', {
      url: '/help',
    ...
    //PACS Query
    .state('app.pacs.query', {
      url: '/query',
      templateUrl: 'views/pacs/query.html',
      controller: 'PacsQueryCtrl'
    })
    //DICOM Viewer
    .state('dicomviewer',{
      url: '/dicomviewer?uid&study',
      params: {
        uid: null,
        study : null
      },
      controller: 'DicomViewerCtrl',
      templateUrl: 'views/dicomviewer/room.html',
      resolve: {
        plugins: ['$ocLazyLoad', function($ocLazyLoad) {
          return $ocLazyLoad.load([
            'scripts/vendor/siri-nova/togetherjs-config.js',
            'scripts/vendor/siri-nova/togetherjs-min.js'
          ]);
        }]
      }
    })
    ...
    //     togetherjs : null
    //   },
    //   controller: 'EasyDicomCtrl',
    //   templateUrl: 'views/easydicom/index.html',
    //   resolve: {
    //     plugins: ['$ocLazyLoad', function($ocLazyLoad) {
    //       return $ocLazyLoad.load([
    //         'scripts/vendor/siri-nova/togetherjs-config.js',
    ...
    // })
    .state('esdcRoom',{
      url: '/name/:boxName?togetherjs',
      params: {
        boxName : null,
        togetherjs: null
      },
      templateUrl: 'views/easydicom/room.html',
